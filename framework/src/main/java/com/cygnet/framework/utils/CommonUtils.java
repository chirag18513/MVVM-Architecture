...
public class CommonUtils {
   ...
   /* public static DeviceRegistration getDeviceInfo(String aUserId) {
        ...
        try {
            pInfo = ModelApp.getAppInstance().getApplicationContext().getPackageManager().getPackageInfo("com.pharmacare.fatblaster", 0);
    ...
    /**
     * Created By : dev1618<br/>
     * Created Date : 10/30/2017<br/>
